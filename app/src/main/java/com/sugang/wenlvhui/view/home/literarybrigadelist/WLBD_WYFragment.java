 ...
 */
public class WLBD_WYFragment extends BaseFragment<wlbdPresenterImp> implements WlbdContract.WlbdView {


    @BindView(R.id.WLBD_WYRecy)
    RecyclerView WLBDWYRecy;


    public WLBD_WYFragment() {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_wlbd__wy;
    }
    ...
    public void showWlbdHsBean(WlbdHsBean wlbdHsBean) {
        if (wlbdHsBean.getData()!=null) {
            ...
            WLBDWYRecy.setLayoutManager(new LinearLayoutManager(getActivity()));
            WlbdAdapter wlbdAdapter = new WlbdAdapter(bangdan);
            WLBDWYRecy.setAdapter(wlbdAdapter);
