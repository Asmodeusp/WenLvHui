 ...
 */
public class WLBD_HsFragment extends BaseFragment<wlbdPresenterImp> implements WlbdContract.WlbdView {


    @BindView(R.id.WLBD_HsRecy)
    RecyclerView WLBDHsRecy;


    public WLBD_HsFragment() {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_wlbd__hs;
    }
    ...
    public void showWlbdHsBean(WlbdHsBean wlbdHsBean) {
        if (wlbdHsBean.getData()!=null) {
            ...
            WLBDHsRecy.setLayoutManager(new LinearLayoutManager(getActivity()));
            WlbdAdapter wlbdAdapter = new WlbdAdapter(bangdan);
            WLBDHsRecy.setAdapter(wlbdAdapter);
